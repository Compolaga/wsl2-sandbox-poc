...
`bin/sandbox proof` kan een oude evidence-map zonder `run.json` nog steeds lezen.
...
[`../docs/decisions.md`](../docs/decisions.md). Herhaal de controles op de eigen doelomgeving; beschouw
...
automatische suite én de handmatige route uit `docs/VERIFICATION.md` groen, inclusief de
Read-tool-controles. De ruwe uitvoer van die aanvullende laptoprun staat niet in deze
publieke repository; `docs/decisions.md` registreert de conclusie en de herkomst, maar is geen
