...
leesbare losse commandoketen werd goedkeuringsplichtig. `run.sh` markeerde dit als ONGELDIG
...
maar is geen vrijgavepoort. De interactieve controles in [VERIFICATIE.md](VERIFICATIE.md)
...
`testomgeving/meet-bubblewrap.sh`.
...
uur. Script: `testomgeving/azure-wsl2-vm.sh`.
