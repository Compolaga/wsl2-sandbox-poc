...
#
# Dit bestand bestaat omdat run.sh en selftest.sh dezelfde regel nodig hebben. Ze hadden er
# elk een eigen kopie van, en die liepen uiteen: selftest.sh besliste of de PROBE-poort gold
# aan de hand van de uitvoer, run.sh aan de hand van de aanroeper. Vrije tekst zonder enige
# marker - wat een CLI teruggeeft die op authenticatie sneuvelt - kwam er bij de een als
# "pass" uit en bij de ander als "ongeldig". De zelftest die moest aantonen dat run.sh goed
